    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative bg-white overflow-hidden">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gradient-to-r from-primary/20 to-secondary/20 sm:h-72 md:h-96 lg:w-full lg:h-full"></div>
        </div>
      </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Pesquisa automática</p>
                </dt>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Análise de dados</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Insights estratégicos</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
      ...
      <div id="pricing" className="bg-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl font-poppins">
